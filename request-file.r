...
win95-version: 0.0.4
do load-thru http://proton.cl-ki.uni-osnabrueck.de/REBOL/win95.r
...
request-file: func [
	...
	hit: func [col row /local file ori last-hit] [
		last-hit: [none none]
		...
		either dir? file [
			...
			change last-hit [none none]
		] [
			tmp: reduce [copy ori now]
			if tmp = last-hit [ok: yes hide-popup]
	...
	lay: layout [
		...
		below
			...
			file-list: list 500x300 255.255.255 [across at 0x0 space 0
				...
				file1: label 250x15 - 15x0 0.0.0 255.255.255 left
					[hit 1 file1/user-data]
				...
				file2: label 250x15 - 15x0 0.0.0 255.255.255 left
					[hit 2 file2/user-data]
					with [font: [colors: [0.0.0 0.0.0]]]
			] supply [
			    either all [
			...
			"Help" [
				"About" [
					inform layout [
						styles skin-win95
						backdrop
						title "Win95-Request-File"
						label "by Frank Sievertsen"
						label "Thanks to DocKimbel for the Win95-Skin!"
						button "OK"
					]
				]
			]
