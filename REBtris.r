...
rebtris: make object! [
	...
	init: func [/local ex] [
		...
		lay: layout [
			...
			panel 0.0.0 effect [gradient 0x1 100.0.0 0.100.0] [
			...
			return
			title "REBtris"
			subtitle "Frank Sievertsen" with [font: [size: 12]]
			panel 0.0.0 [
				size (stone/size * 5x4)
			]
